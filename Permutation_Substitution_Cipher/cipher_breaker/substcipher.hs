...
init_guess x = map (\i -> ((fst (x !! i)), (freq_table !! i))) [0..(min 25 ((length x) - 1))] 
               where freq_table = ['e','a','l','i','o','t','n','s','w','c','u','d','p','m','h','g','b','f','y','r','k','v','x','z','j','q']
...
nPseudorandomNumbers seed a = take 9000 . randomRs (0, a) . mkStdGen $ seed
...
iterates w dict hmap randNums 9000 = hmap
